...
import { FolderOpen, LogOut, User, Briefcase, Shield } from "lucide-react";
...
export function AppHeader() {
  ...
  return (
    <header className="mx-auto flex w-full max-w-3xl items-center justify-between gap-3 px-5 pt-6 sm:px-8">
